...
public final class DevpConstant {
	...
	public static final String E_PRD_IDEPRJ = "PrdIdeprj";

	public static final String E_MODULE = "Module";
	public static final String E_MODULE_PRD = "ModulePrd";
	public static final String E_MODULE_MDU = "ModuleMdu";
	public static final String E_MODULE_FUN = "ModuleFun";

	public static final String E_UML_DIAGRAM = "UmlDgm";
}

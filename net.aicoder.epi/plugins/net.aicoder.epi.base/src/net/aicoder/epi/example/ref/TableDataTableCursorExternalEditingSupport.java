...
public class TableDataTableCursorExternalEditingSupport extends TableDataTableCursor{
	...
	public TableDataTableCursorExternalEditingSupport(TableViewer tableViewer) {
	    super(tableViewer);
        //this.editor = editor;
/**        
...
**/        
	...
	/**
	 * @see net.aicoder.epi.base.view.element.ref.datatools.sqltools.data.internal.ui.editor.TableDataTableCursor#edit()
	 */

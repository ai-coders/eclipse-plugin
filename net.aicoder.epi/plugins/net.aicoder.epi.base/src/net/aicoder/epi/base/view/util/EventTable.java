 ...
 *******************************************************************************/
package net.aicoder.epi.base.view.util;
...
public class EventTable {
  private final Map<Class<?>, List<?>> m_listenerClassToListener = new HashMap<Class<?>, List<?>>(0);
  ...
  public <T extends Object> void addListener(Class<T> listenerClass, T listener) {
    ...
    if (listeners == null) {
      listeners = new ArrayList<T>(0);//Lists.newArrayList();

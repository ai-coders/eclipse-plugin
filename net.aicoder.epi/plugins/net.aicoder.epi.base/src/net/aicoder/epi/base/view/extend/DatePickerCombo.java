...
//						text.setText(formatDate(date));
	 ...
	 *
	 */
	public static class DatePickerComboCellEditor extends CellEditor{
		private DatePickerCombo datePickerCombo;
		private String currentType;
		
		public DatePickerComboCellEditor(Composite parent,String currentType) {
			super(parent);
		...
		protected Object doGetValue() {
			String comboText = datePickerCombo.getText();
			return comboText;
		}

		@Override
		protected void doSetFocus() {
			if (datePickerCombo != null) {

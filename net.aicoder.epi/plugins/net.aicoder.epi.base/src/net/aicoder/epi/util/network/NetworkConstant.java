...
public class NetworkConstant{
	...
	public static final String PRODUCTOPS_SYS_DPY_RESOURCES = HOST+"/supply/load_devpsysdpyresources/";//产品关联资源	
	public static final String PRODUCTOPS_SYS_DPY_RES_INST = HOST+"/supply/load_devpsysdpyresinst/";//产品资源应用场景
	public static final String PRODUCTOPS_SYS_DPY_SCHEMA = HOST+"/supply/load_devpsysdpyschema/";//产品部署方案
	public static final String PRODUCTOPS_OPS_ASSET_CMDB = HOST+"/supply/load_devpopsassetcmdb/";//产品IT资源	

 ...
 *******************************************************************************/
package net.aicoder.epi.util.execution;
...
public class ExecutionUtils {
	 ...
	 * At least one events loop will be executed. If current thread is not UI
	 * thread, then this method works just as {@link #sleep(int)}.
	 */
	...
	/**
	 * Runs given {@link RunnableEx} and logs exceptions using
	...
	/**
	 * Runs given {@link RunnableEx} and re-throws exceptions using
	...
	/**
	 * Ensures that {@link Beans#isDesignTime()} returns <code>true</code> and runs
	 * given {@link RunnableEx}.
	 */
	...
	////////////////////////////////////////////////////////////////////////////
	/**
	 * Runs given {@link RunnableEx} inside of UI thread, using
	 * {@link Display#syncExec(Runnable)}.
	 *
	 * @return <code>true</code> if {@link RunnableEx} was executed without any
	 *         {@link Exception}.
	 */
	...
	/**
	 * Runs given {@link RunnableEx} within UI thread using
	 * {@link Display#asyncExec(Runnable)}. Logs a {@link Throwable} which may
	 * occur.
	 */
	 ...
	 * Runs given {@link RunnableEx} and ignores exceptions.
	 *
	 * @return the {@link Object} returned by {@link RunnableEx#run()} or
	 *         <code>defaultValue</code> if exception happened.
	 */
	 ...
	 *
	 * @return the {@link Object} returned by {@link RunnableEx#run()} or
	 *         <code>defaultValue</code> if exception was logged.
	 */
